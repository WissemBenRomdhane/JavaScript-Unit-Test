...
describe("createAccount", () => {
    let newEmailAddress = "benr.wissem@gmail.com";
    beforeEach(() => {
    ...
    test("Returns user data when account created successfully - resolves", () => {
        ...
        return expect(account.createAccount(newEmailAddress)).resolves.toStrictEqual({ "data": {"userId": 2, "username": newEmailAddress}});
    });
